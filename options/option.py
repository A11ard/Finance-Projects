...
class bsm:
    def __init__(self, call, x, r, t, price=None, cdiv=0, stockprice=None, vol=None, stock=None, time_stock=None):
        ...
        if (stock is not None) and (time_stock is not None):
            ...
            #theta: divide by 365 to get the effect on price given a 1 DAY change
            #vega: divide by 100 because this represents a 1 POINT change in Volatility, which is a percetage
        else:
